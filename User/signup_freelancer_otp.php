...
if (isset($_POST['submit'])){
    ...
    if($rand2==$otp){
        ...
        // $insert="INSERT INTO `freelancer` VALUES(NULL,'$name','$email','$passwordhashing','0','0',$nationalId,'$birthDate',NULL,NULL,NULL,1,NULL,NULL,'default.jpg',0)";
        // $insert="INSERT INTO `freelancer` VALUES(NULL,'$name','$email','$passwordhashing','0','0',$nationalId,'$birthDate',$cat,NULL,NULL,NULL,1,NULL,NULL,'default.jpg',0)";
        $insert="INSERT INTO `freelancer` VALUES(NULL,'$name','$email','$passwordhashing','0','0',$nationalId,'$birthDate','$cat',NULL,NULL,NULL,1,NULL,NULL,'default.jpg',0)";
...
// php mail start->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
$mail->setFrom('maloka.elhalawany@gmail.com', 'website_name');          //sender mail address , website name
