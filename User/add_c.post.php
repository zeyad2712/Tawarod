...
<head>
    ...
    <link rel="stylesheet" href="./css/addpost-community.css">
     <!-- ----------------------------------bootstrap link-------------------------------------  -->
...
<body>
    ...
    <form method="POST" name="category" enctype="multipart/form-data">
               ...
               <textarea name="desc" id="" placeholder="What's In Your Mind? " required></textarea>
                ...
                <input type="file" name="img" id="p-img">
                <div class="btnn"><button name="submit" type="submit" class="btn1">Post</button></div>
