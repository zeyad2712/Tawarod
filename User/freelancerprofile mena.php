...
<nav class="sidebar close" id="ssideBarr">
    <header>
    ...
    <div class="home">
        <div class="main">
                    ...
                    <?php if ($number > 0) {
                        foreach ($run_select as $data) { ?>
                               <a href="<?php echo $data['link']; ?>">  
                                <div class="linkkk">
                               <i class="fa-solid fa-link" style="color: #c18d52;"></i> <?php echo $data['link']; ?>
                            </a>
                            <a href="freelancerprofile mena.php?delete_l=<?php echo $data['link_id']?>"><i class="fa-solid fa-trash" style="color: #c18d52;"></i></a>
                ...
                <h1 class="v">Visibilty</h1>
                    ...
                    <form method="POST">
                        <?php if($hide==0){?>
                                ...
                                <button class="invis"  type="button" onclick="openPopupvis()">Invisible</button>
                                <?php }else{ ?>
            ...
            <div class="main-sec">
                ...
                <p class="p-info">Full Name: <?php echo $name; ?></p>
                    <p class="p-info">Email: <?php echo $email; ?></p>
                    <p class="p-info">Rank: <?php echo $rank_name ?></p>
                    <hr>
                ...
                <p>Views:<?php echo $views ?> </p>
                    ...
                    <i class="fa-regular fa-pen-to-square" style="color: #0c0d0d;"></i>
                    </button>
                </span> </p>
                ...
                <div class="upload">
                <a href="my project_f.php" class="add1">My project </a><br>
                        ...
                        <?php if ($number_sample > 0) {
                            foreach ($run_sample as $run) { ?>
                                <div class="sample">
                                    ...
                                    <div class="big-btns">
                                        <div class="mini-btns">
                                            <a href="edit_sample.php?edit=<?php echo $run['sample_id']?>"> <i class="fa-regular fa-pen-to-square" style="color: blue;"></i></a>
                                            <!-- -------------------------------------open delete popup------------------------------------- -->
                                            <a   onclick="showPopupds(<?php echo $run['sample_id']; ?>)"> <i class="fa-solid fa-trash" style="color: red;"></i></a>
                                        </div>
                                    </div>
                                </div>
                            <?php }
...
<?php } ?>
<!-- -------------------------------------visibilty popup------------------------------------>
<div class="container-save d-none" id="vis">
    <form action="" method="POST" >
        <div class="cookiesContent">
            <button class="close" type="button" onclick="closePopuvisp()">
                <i class="fa-solid fa-xmark" style="color: #c18d52;"></i>
            </button>
            <img src="./images/vis.png" alt="cookies-img" />
           <p>Are Your Sure You Want To Make Your Profile Invisible?</p>
            <button class="accept" name="unhide" type="submit">Yes</button>
        </div>
    </form>
</div>
<!-- ---------------------------------delete sample--------------------------------- -->
 <!-- Delete confirmation popup -->
<div class="container-save d-none " id="d-sample">
    <form action="" method="POST" id="deleteForm">
        <div class="cookiesContent" id="cookiesPopup">
            <button class="close" type="button" onclick="closePopupds() ">✖</button>
...
const popupds = document.getElementById("d-sample");
    const projectIdInput = document.getElementById("projectId");
    const deleteForm = document.getElementById("deleteForm");

    function showPopupds(projectId) {
        popupds.classList.remove('d-none');
        projectIdInput.value = projectId;
    }

    function closePopupds() {
        popupds.classList.add("d-none");
        ...
        var popupvis = document.getElementById("vis")

        function openPopupvis() {
        popupvis.classList.remove("d-none")
        }
        function closePopuvisp() {
        popupvis.classList.add("d-none")
        }
...
<script>
    ...
    var sidebar = document.getElementById("ssideBarr")
