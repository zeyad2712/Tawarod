...
if(isset($_GET['view_profile'])){
    ...
    $freelancer_id=$_GET['view_profile'];  
    $_SESSION['view_profile']=$freelancer_id;
}
    ...
    if (isset($_POST['submit'])) {
        ...
        // $report=$_POST['report'];
        $freelancer_id=$_SESSION['view_profile'];
        $client_id=$_SESSION['client_id'];
        if(!empty($report)){
        $insert="INSERT INTO `reports` VALUES (NULL,'$client_id','$freelancer_id','$report')";
        $run_insert = mysqli_query($connect, $insert);
        
        }else{
            echo"please add your feadback";
        }
...
<body>
   ...
   <div class="report">
    <form  method="POST">
    <label for="report" id="report">Enter Your Report</label><br>
    <input type="text" name="report" id="report" placeholder=" Report Here...."><br>
